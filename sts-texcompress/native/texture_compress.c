/*
 * texture_compress.c  (standalone build — no LWJGL headers needed)
 *
 * On-the-fly software texture compression (DXT1/DXT5 and ETC2 RGB8/RGBA8).
 * Detected at runtime from GL_EXTENSIONS; falls back gracefully if neither
 ...
 *
 * JNI class: com.texcompress.NativeCompressor
 *
 * Build:
 *   gcc -O2 -shared -fPIC -std=c99 \
 *       -I$JAVA_HOME/include -I$JAVA_HOME/include/linux \
 *       texture_compress.c -o libtexcompress.so -ldl
 */
...
/* ==========================================================================
 * JNI entry points
 * Class: com.texcompress.NativeCompressor
 * ========================================================================== */

JNIEXPORT jint JNICALL
Java_com_texcompress_NativeCompressor_nDetectFormat(
...
JNIEXPORT jint JNICALL
Java_com_texcompress_NativeCompressor_nGetCompressedSize(
...
Java_com_texcompress_NativeCompressor_nCompress(
